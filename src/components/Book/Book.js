...
import { addReadingList, finishedList, removeFromReadingList } from "../../Redux/action/bookActions";
  ...
  return (
    ...
    >
      ...
      <div className={styles.control_icons} >
        ...
        onClick={()=>dispatch(addReadingList(props.book))}
        />
        <HiCheckCircle title="Mark as Finish" className={styles.check_icon} 
          onClick={()=>dispatch(finishedList(props.book))}
        />
      </div>
    </div>
  );
